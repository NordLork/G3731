...
int[,] matrix0 = SpiralMatrix(size);
PrintResult("Решение Александр: " + (DateTime.Now - d0));
// DrawMatrix(SpiralMatrix(size), size * size);
